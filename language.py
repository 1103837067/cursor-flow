    ...
    def __init__(self):
        ...
        self.translations = {
            "cn": {
                ...
                "db_schema": "数据库Schema: {schema}",
                
                # Database messages
                "db_init_success": "数据库初始化成功",
                "db_init_failed": "数据库初始化失败: {error}",
                "db_engine_created": "数据库引擎创建成功: {url}",
                "db_schema_created": "已确保Schema存在: {schema}",
                "db_schema_error": "创建Schema时出错: {error}",
                "db_connection_error": "数据库连接错误: {error}",
                "db_rollback_error": "回滚过程中出错: {error}",
                "db_close_error": "关闭会话时出错: {error}",
                "db_dispose_error": "释放引擎时出错: {error}",
                "db_account_update": "更新现有账号信息 (ID: {id})",
                "db_account_create": "创建新账号记录",
                "db_account_save_success": "账号 {email} 信息保存成功",
                "db_account_save_failed": "保存账号 {email} 信息到数据库失败: {error}",
                "db_saving_remote": "正在保存账号信息到远程数据库...",
                "db_save_success": "账号 {email} 信息已成功保存到远程数据库",
                "db_save_failed": "保存账号 {email} 信息到远程数据库失败",
                "db_save_error": "保存账号信息到数据库时发生错误: {error}",
            ...
            "en": {
                ...
                "db_schema": "Database schema: {schema}",
                
                # Database messages
                "db_init_success": "Database initialization successful",
                "db_init_failed": "Database initialization failed: {error}",
                "db_engine_created": "Database engine created successfully: {url}",
                "db_schema_created": "Ensured schema exists: {schema}",
                "db_schema_error": "Error creating schema: {error}",
                "db_connection_error": "Database connection error: {error}",
                "db_rollback_error": "Error during rollback: {error}",
                "db_close_error": "Error closing session: {error}",
                "db_dispose_error": "Error disposing engine: {error}",
                "db_account_save_start": "Starting to save account information to database: {email}",
                "db_account_update": "Updating existing account information (ID: {id})",
                "db_account_create": "Creating new account record",
                "db_account_save_success": "Account {email} information saved successfully",
                "db_account_save_failed": "Failed to save account {email} information to database: {error}",
                "db_saving_remote": "Saving account information to remote database...",
                "db_save_success": "Account {email} information successfully saved to remote database",
                "db_save_failed": "Failed to save account {email} information to remote database",
                "db_save_error": "Error saving account information to database: {error}",
